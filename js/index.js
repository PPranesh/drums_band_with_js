...
function listenToValues(key) {
    ...
    switch (key) {
        case "w":
            var w_button = new Audio("/sounds/tom-3.mp3").play();
            break;
        case "a":
            var a_button = new Audio("/sounds/snare.mp3").play();
            break;
        case "s":
            var s_button = new Audio("/sounds/tom-1.mp3").play();
            break;
        case "d":
            var d_button = new Audio("/sounds/kick-bass.mp3").play();
            break;
        case "j":
            var j_button = new Audio("/sounds/tom-2.mp3").play();
            break;
        case "k":
            var k_button = new Audio("/sounds/crash.mp3").play();
            break;
        case "l":
            var l_button = new Audio("/sounds/tom-4.mp3").play();
            break;
        default:
